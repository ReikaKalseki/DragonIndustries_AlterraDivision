...
namespace ReikaKalseki.DIAlterra
{
	public class VanillaFlora {
		...
		public static readonly VanillaFlora CAVE_BUSH = new VanillaFlora("4856ff40-43d2-4b15-acdc-d6a45f85c157", 6, 0.4).markHarvestable();
		...
		public static readonly VanillaFlora PYGMY_FAN = new VanillaFlora("ae0a831e-0f90-43bd-8183-c2002c528e9e", 6.2).markHarvestable();
		public static readonly VanillaFlora PYGMY_FAN_HUGE = new VanillaFlora("e65b36c8-3b85-463c-8f30-95859401b2cb", 6, 3);
		...
		public static readonly VanillaFlora KOOSH = new VanillaFlora("f90ba94f-326b-4cbd-bc95-4dc39addbf33", 5.8, 0.2).markEdible();
		public static readonly VanillaFlora LARGE_KOOSH = new VanillaFlora("a9958cbb-72eb-4a1d-af7b-13fbc947d8f3", 6, 2.5); //fcf04278-bfbb-409d-bada-a6f22564efde
		public static readonly VanillaFlora EYE_STALK = new VanillaFlora("0089035b-4717-4975-b437-5b87cc3e2f8e", 6.3, 0.3).markHarvestable(); //11ea0dd6-015f-4528-bed7-18de03f54911 and 320c9798-9e57-4055-8daa-d73a055c0d28
		public static readonly VanillaFlora GELSACK = new VanillaFlora("74f368f4-b08f-4b0c-ab96-c97e37911ff0", 6).markResources(); //bd4d4fa1-d10e-40e5-8ec6-67efd0ba03af and dd037903-eb47-47f5-9d4f-83100aca4ec4
		public static readonly VanillaFlora MEMBRAIN = new VanillaFlora("0e2a3f36-881b-4c84-8a02-5bb1da4b9f29", 6).markHarvestable();
		public static readonly VanillaFlora REGRESS = new VanillaFlora("1a806d20-dc8f-4e6e-9281-f353ed155abf", 6.2).markHarvestable();
		public static readonly VanillaFlora SEACROWN = new VanillaFlora("a1040915-abcf-4843-a16f-39a10d6a1c2d", 5.9, 0.1).markHarvestable();
		...
		public static readonly VanillaFlora SPOTTED_DOCKLEAF = new VanillaFlora("b2636f23-f764-41ec-bfcf-f33d35d79641", 6).markHarvestable();
		...
		public static readonly VanillaFlora GHOSTWEED = new VanillaFlora("1bb43d52-19ee-4a3a-85ef-f85a152cc334", 6.1, 0.2).markHarvestable();
		...
		public static readonly VanillaFlora MING = new VanillaFlora("1d5877a7-bc56-46c8-a27c-f9d0ab99cc80", 6.1).markHarvestable(); //ce650c66-355c-4b77-ad4e-a2bea7e36c95
		...
		public static readonly VanillaFlora POTATO = new VanillaFlora("533d54b0-e54a-4aec-8dd0-a9eb89868c59", 5.9, 0.5).markEdible();
		public static readonly VanillaFlora MARBLEMELON = new VanillaFlora("e9445fdf-fbae-49dc-a005-48c05bf9f401", 5.9, 0.3).markEdible();
		public static readonly VanillaFlora LARGE_MARBLEMELON = new VanillaFlora("a966a14f-d188-4de4-a488-f2c0302ca250", 6.2, 0.4).markEdible();
		public static readonly VanillaFlora FERN_PALM = new VanillaFlora("1d6d89dd-3e49-48b7-90e4-b521fbc3d36f", 6, 0.4).markHarvestable(); //523879d5-3241-4a94-8588-cb3b38945119
		public static readonly VanillaFlora GRUB_BASKET = new VanillaFlora("28c73640-a713-424a-91c6-2f5d4672aaea", 6).markHarvestable();
		public static readonly VanillaFlora LANTERN = new VanillaFlora("8fa4a413-57fa-47a3-828d-de2255dbce4f", 6.1, 1).markEdible();
		public static readonly VanillaFlora PINK_CAP = new VanillaFlora("a7aef01f-0dc0-4d03-913d-d47d8d2ba407", 5.8).markHarvestable(); //7f9a765d-0b4e-4b3f-81b9-38b38beedf55 and c7faff7e-d9ff-41b4-9782-98d2e09d29c1 and e88e7a23-2a99-41c5-aed9-a2bfaca3619d
		...
		public static readonly VanillaFlora BLOOD_GRASS = new VanillaFlora("ae210dd4-68f0-4c77-9025-ef7d116948b3", 5.8);
		...
		public static readonly VanillaFlora CRASHFISH = new VanillaFlora("eb38de5d-c3df-4446-a37a-d770fb0f92bb", 6.5, 0.5); //THIS IS A FULL CRASHFISH
